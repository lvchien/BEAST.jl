...
``` 
ref_mesh_size = 0.02
Γ_ref = meshcuboid1hole(1.0, 0.5, 0.5, ref_mesh_size)
...
### Computational mesh
for meshsize in [0.45, 0.4, 0.35, 0.3, 0.25, 0.2, 0.185, 0.18, 0.16, 0.15, 0.135, 0.13, 0.12, 0.11, 0.1, 0.09, 0.075, 0.07, 0.065, 0.055, 0.05, 0.04, 0.03]
    # meshsize = 0.3
    Γ = meshcuboid1hole(1.0, 0.5, 0.5, meshsize)
