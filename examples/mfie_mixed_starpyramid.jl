``` 
    This script file aims at calculating the scattering of an electromagnetic plane-wave by a star-based pyramid PEC using the mixed MFIE discretization.
...
``` 
ref_mesh_size = 0.02
Γ_ref = meshstarpyramid(1.0, 0.3, 24, 0.5, ref_mesh_size)
